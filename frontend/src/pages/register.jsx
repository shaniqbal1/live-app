        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 animate-fade-in-up-delay">
            ...
            <button
              ...
              className="w-full btn-magic text-white py-4 rounded-xl font-semibold transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isSubmitting ? (
                <>
          ...
          {/* Divider */}
          <div className="mt-8 divider animate-fade-in-up-delay-2">
          ...
          <div className="mt-6 animate-fade-in-up-delay-2">
            <button
              ...
              className="w-full btn-google text-gray-700 py-5 rounded-xl font-semibold transition-all duration-300 flex items-center justify-center gap-3 text-base"
            >
